...
export const PALETTE: Record<DitherColor, Seed> = {
  ...
  // The site's brand primary (oklch 72.29% 0.075 300.665 ≈ rgb 173,155,206),
  // kept in the same violet hue but saturated for a legible area fill.
  primary: { fill: [151, 107, 214], line: [200, 175, 245], star: [228, 214, 255] },
}
